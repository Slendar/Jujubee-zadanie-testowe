...
[CreateAssetMenu(fileName = "New Cold Weapon", menuName = "Weapons/Cold Weapon")]
public class ColdWeaponSO : ScriptableObject, IWeapon
{
    ...
    public bool isKindness = false;
    public float sharpness = 20;
}